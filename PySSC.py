#Created with SAM version 2016.3.14
...
class PySSC:
	def __init__(self):
		if sys.platform == 'win32' or sys.platform == 'cygwin':
			self.pdll = CDLL("C:/Users/Admin/Downloads/sam-sdk-2016-3-14-r3/languages/python/ssc.dll") 
		elif sys.platform == 'darwin':
			self.pdll = CDLL("C:/Users/Admin/Downloads/sam-sdk-2016-3-14-r3/languages/python/ssc.dylib") 
		elif sys.platform == 'linux2':
			self.pdll = CDLL('C:/Users/Admin/Downloads/sam-sdk-2016-3-14-r3/languages/python/ssc.so')   # instead of relative path, require user to have on LD_LIBRARY_PATH
		else:
